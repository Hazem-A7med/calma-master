...
class _CreateChampionsState extends State<CreateChampions> {
  ...
  int tagClubs = 0;
  List<String> typeClubs  = [
    'رابطه مشجعين','اكاديمية', 'نادي'
  ];
  int tagSub = 0;
  List<String> typeSub  = [
   'غير مختلط', 'مختلط'
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocConsumer<NadekCubit,NadekState>(
        ...
        builder:(context, state)=>  isLoadeing? const Center(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      child:path ==null ?const Row(
                        children: [
                          Expanded(
                            child: Icon(Icons.image,size: 50,),
                          ),
                          Expanded(
                            child: Text('اضغط هنا لرفع صوره النادي الخاص بك '),
                          )
                        ],
                      ): ClipRRect(
                        borderRadius: BorderRadius.circular(20),
                ...
                GestureDetector(
                  ...
                  child: Container(
                      ...
                      child: Center(child: Text('تأكيد النشاء',style: TextStyle(color: Colors.white),))

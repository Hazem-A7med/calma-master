...
class _CartState extends State<Cart> {
  ...
  void initState() {
    ...
    BlocProvider.of<NadekCubit>(context).GetFromCart(token: token!);
  }
                              ...
                              children: [
                                ListView.builder(
                                    ...
                                    itemBuilder: (item, index) {
                                      return Item(
                                        id: getCart!.data!.cartItems![index]
                                            .product!.id,
                                        title:
                                            '${getCart?.data?.cartItems?[index].product?.title}',
                                        desc: getCart?.data?.cartItems?[index]
                                            .product?.description,
                                        price: getCart!.data!.cartItems![index]
                                            .product!.price
                                            .toString(),
                                        image: getCart?.data?.cartItems?[index]
                                            .product?.imagePath,
                                        total: int.parse(getCart!
                                            .data!.cartItems![index].quantity
                                            .toString()),
                                        function: () {
                                          BlocProvider.of<NadekCubit>(context)
                                              .RemoveFromCart(
                                            product_id: getCart!.data!
                                                .cartItems![index].product!.id!
                                                .toInt(),
                                            quantity: -int.parse(getCart!.data!

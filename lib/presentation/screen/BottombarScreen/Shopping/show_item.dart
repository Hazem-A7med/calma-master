...
class Show_Item extends StatefulWidget {
  ...
  Show_Item(
      {Key? key, required this.PID, required this.url, required this.title, required this.description, required this.price});
...
class _Show_ItemState extends State<Show_Item> {
  ...
  void addCart() {
      nadekCubit.PostToCart(product_id: widget.PID!.toInt(), quantity: total, token: '$token');
      setState(() {
        waiting =true;

...
class shopoing extends StatefulWidget {
  ...
  shopoing({Key? key,required this.categories,required this.tokens,required this.count}) : super(key: key);
...
class _shopoingState extends State<shopoing> with TickerProviderStateMixin {
  ...
  void initState() {
    // TODO: implement initState
    _tabController = TabController(length: widget.categories!.data!.length, vsync: this);
        ...
        child: Scaffold(
            appBar: AppBar(
                ...
                leading:badges.Badge(
                  ...
                  badgeContent: Text('${widget.count}',style: TextStyle(color: Colors.white),),
                  child: IconButton(
                    icon: Image(
                      height: 30,
                      width: 30,
                ...
                children: [
                  ...
                  Padding(
                      ...
                      child:  TabBar(
                        ...
                        tabs: List.generate(widget.categories!.data!.length, (index){
                  ...
                  Flexible(
                      child:TabBarView(
                          controller: _tabController,
                          children: List.generate(widget.categories!.data!.length, (index){
                            return GridView.builder(
                                shrinkWrap: true,
                                gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2),
                                itemCount: widget.categories!.data![index].products!.length,
                                  ...
                                  return GestureDetector(
                                    onTap: (){
                                      Navigator.pushNamed(
                                          ...
                                          '/Show_Item',
                                          arguments: [
                                            widget.categories!.data![index].products![index1].id,           //id
                                            widget.categories!.data![index].products![index1].imagePath, //url
                                            widget.categories!.data![index].products![index1].title,    //title
                                            widget.categories!.data![index].products![index1].description, //descr
                                            widget.categories!.data![index].products![index1].price        //price
                                    ...
                                    child: Padding(
                                      ...
                                      child: Component_App.Item_Shoping(
                                          file:'${widget.categories!.data![index].products![index1].imagePath}',
                                          title: '${widget.categories!.data![index].products![index1].title}'
                                      ),
                                    ),
                                  );
                                }
...
class ItemCategory extends StatefulWidget {
  ...
  String? title;
  Color ? color;
  ItemCategory({Key? key,required this.file,required this.color,required this.title}) : super(key: key);

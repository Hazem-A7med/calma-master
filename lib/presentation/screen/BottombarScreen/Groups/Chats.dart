            ...
            children: [
              ...
              Expanded(
                ...
                child: TextField(
                  ...
                  style: const TextStyle(color: ColorApp.black_400),
                  cursorColor: ColorApp.black_400,
                  decoration: const InputDecoration(
                      filled: true,
                      border: InputBorder.none,
                      hintText: "ادخل نص رسالتك ",
                      hintStyle: const TextStyle(color: ColorApp.black_400)),
                ),
              )
            ],
          )),
...
class MessageStreamBuilder extends StatelessWidget {
  ...
  MessageStreamBuilder(
      {Key? key, required this.chat_id, required this.sender, required this.id})
      : super(key: key);
